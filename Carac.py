...
def InitializeCarac(base):
    ...
    for entry in ["Force","Endurance","Vitesse","Perception","Précision","Social","Intelligence","Sensibilité","Volonté"]:
        if base==None:
            Carac[entry]=None
        else:
...
def BonusAge(age,agemin,agemax,age1=0,age2=0):
    ...
    Bonus["Endurance"]=FuncUpStableDown(0.7,age,agemin,age1,age2,agemax)
...
def CalculeCarac2(Perso,Equipement=None,XPRandom=0):
    C=Perso.Carac
    C2=dict()
    C2["P2V"]=(C["Force"]+C["Endurance"]+C["Volonté"])
